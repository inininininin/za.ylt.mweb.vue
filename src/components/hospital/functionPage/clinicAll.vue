                ...
                <li v-for="(item,inx) in personnelList" :key="inx">
                    <div class="li_top">
                        ...
                        <div class="li_top_right">
                            <img v-if="item.status==4" draggable="false" src="../../../assets/yijiuzhen@2x.png" alt="">
                            <img v-if="item.status==1" draggable="false" src="../../../assets/weijiuzhen@2x.png" alt="">
                            <span :style="{'color':item.status==4? '#4DD865':'#2B77EF'}">已就诊</span>
                        </div>
                    </div>  
                    <div class="li_time">
